...
from nanobot.config.loader import get_config_path, load_config, save_config, get_data_dir
from nanobot.config.schema import Config
from nanobot.team.runtime import TeamRuntime
from nanobot.team.store import TeamStore
from nanobot.controlplane.terminal import TerminalManager
...
def serve_control_plane(host: str = "127.0.0.1", port: int = 18880) -> None:
    config = load_config()
