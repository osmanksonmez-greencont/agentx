...
from agentx.cli import commands
...
def mock_prompt_session():
    ...
    with patch("agentx.cli.commands._PROMPT_SESSION", mock_session), \
         patch("agentx.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("agentx.cli.commands.PromptSession") as MockSession, \
         patch("agentx.cli.commands.FileHistory") as MockHistory, \
