...
class ChannelsConfig(Base):
    ...
    send_thinking: bool = True     # send "Thinking..." indicator before response
...
class SelfEditConfig(Base):
    ...
    enabled: bool = True
    allowed_paths: list[str] = Field(default_factory=lambda: ["agentx", "tests", "README.md"])
    protected_paths: list[str] = Field(
        default_factory=lambda: [".git", ".env", "secrets", "docker-compose.yml"]
    )
    require_validation: bool = True
    lint_command: str = "ruff check agentx tests"
...
class Config(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="AGENTX_", env_nested_delimiter="__")
